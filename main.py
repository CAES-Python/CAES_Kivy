...
#experiment with getting ids from different screens.
	...
	def warning(self,dt):
		...
		elif (self.NCPvalue1 <  75 or self.NCPvalue2 <  50 or self.NCPvalue3 < 60 or self.NCPvalue4 < 90 or self.value2 <  50) and self.value1< 50:
		...
		elif  (self.NCPvalue1 <  75 or self.NCPvalue2 <  50 or self.NCPvalue3 < 60 or self.NCPvalue4 < 90 or self.value1 <  50) and self.value2<50:
